...
export default function AboutIpecSection() {
  return (
    <section className="relative -mt-24 z-2 rounded-t-[80px] bg-white pt-24 pb-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          ...
          <div className="relative">
            <div className="relative overflow-hidden rounded-3xl shadow-xl">
              ...
              {/* Top Badge */}
              <div className="absolute top-4 left-4 rounded-full bg-white px-4 py-2 text-sm font-semibold shadow">
              ...
              <div className="absolute bottom-4 left-4 flex items-center gap-3 rounded-xl bg-white px-4 py-3 shadow">
                ...
                <div className="text-sm">
                  <p className="font-semibold">Reached</p>
          ...
          <div>
            ...
            <p className="mt-4 text-gray-600 leading-relaxed">
              ...
              <strong>
                project planning, scheduling, cost control, risk management,
                and reporting
              </strong>
            ...
            {/* List */}
            <div className="mt-6">
              <p className="font-semibold mb-3">We are committed to:</p>
              <ul className="space-y-3 text-gray-600">
                <li>• Delivering innovative solutions tailored to client needs</li>
                <li>• Fostering collaboration across all stakeholders</li>
                <li>• Building long-term trust through service excellence</li>
                <li>• Creating growth opportunities for clients and partners</li>
              </ul>
            </div>
